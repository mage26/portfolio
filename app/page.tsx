    ...
    <section className="relative flex px-4 w-full max-w-4xl flex-col items-center justify-between sm:items-start">
       <div className="w-full flex items-center justify-center h-[calc(100vh-80px)] flex-col gap-8">
        <h1 
          ...
          data-inview
        >
          <Title className="block uppercase text-6xl md:text-7xl font-black">Benjamin Berlin</Title> 
        ...
        <h2
          ...
          data-inview
        >
          Leading frontend development teams to leverage cutting-edge front-end ecosystems to rapidly create seamless, accessible, and beautifully animated user interfaces.</h2>
       </div>
    </section>
  );
}
