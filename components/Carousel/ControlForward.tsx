...
const CarouselControlForward = forwardRef<HTMLButtonElement, CarouselControlForwardProps>(({
    ...
    const handleClick = useCallback(() => {
        if(!contentElementRef.current || !itemsElementsRefs.current.length) { return; }
        ...
        const nextStopPoint = stopPoints.find((point) => point > roundedScrollLeft) || scrollWidth;
