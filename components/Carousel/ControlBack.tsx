...
const CarouselControlBack = forwardRef<HTMLButtonElement, CarouselControlBackProps>(({
    ...
    const handleClick = useCallback(() => {
        ...
        const previousStopPoint = stopPoints.reverse().find((point) => point < roundedScrollLeft) || 0;
