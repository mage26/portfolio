...
const CarouselContent = forwardRef<HTMLUListElement, CarouselContentProps>(
    (
        ...
        const handleContentScroll = useCallback(() => {
            if(!contentElementRef.current) { return; }
            const { scrollLeft, scrollWidth, clientWidth } = contentElementRef.current;
        ...
        return (
            <Component 
                ...
                className={twMerge(
                    ...
                    isDragging ? 'cursor-grabbing select-none scroll-auto' : 'snap-x snap-mandatory scroll-smooth',
                    className,
                )}
                {...props}
